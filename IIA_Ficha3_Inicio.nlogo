...
globals [blue-nest yellow-nest nKills]
...
to setup-patches
  ...
  ask patches with [pcolor = black]
  [
    if random 101 < 15 [ set pcolor green ]
  ]
...
to move-ants
  ask ants
  [
    ifelse any? snails-on patch-ahead 1[
      if nGrass >= 10
      [
        fd 1
        let prey one-of snails-here
    ...
    [
      ...
      [
        ...
        [
          ...
          [
            fd 1
            set blue-nest blue-nest + nGrass
            set nGrass 0
            set energy energy - 1
            ;;die
          ]
...
"kills" 1.0 0 -2674135 true "" "plot nKills"
